...
public class VideoTrimmerUtil {
  ...
  public static void trim(Context context, String inputFile, String outputFile, long startMs, long endMs, final TrimmerListener callback, boolean addmusic) {
    ...
    try {
      ...
      FFmpeg.getInstance(context).execute(command, new ExecuteBinaryResponseHandler() {
        ...
        @Override public void onSuccess(String s) {
          callback.onFinishTrim(tempOutFile,addmusic);
        }
